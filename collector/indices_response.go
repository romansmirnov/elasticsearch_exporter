...
type IndexStatsIndexIndexingResponse struct {
	...
	IndexTranslogAddTotal                     int64 `json:"index_translog_add_total"`
	IndexTranslogAddTimeInMillis              int64 `json:"index_translog_add_time_in_millis"`
	DeleteTranslogAddTotal                    int64 `json:"delete_translog_add_total"`
	DeleteTranslogAddTimeInMillis             int64 `json:"delete_translog_add_time_in_millis"`
	IndexTranslogSeqnoProcessedTotal          int64 `json:"index_translog_seqno_processed_total"`
	IndexTranslogSeqnoProcessedTimeInMillis   int64 `json:"index_translog_seqno_processed_time_in_millis"`
	DeleteTranslogSeqnoProcessedTotal         int64 `json:"delete_translog_seqno_processed_total"`
	DeleteTranslogSeqnoProcessedTimeInMillis  int64 `json:"delete_translog_seqno_processed_time_in_millis"`
	IndexTranslogSeqnoPersistedTotal          int64 `json:"index_translog_seqno_persisted_total"`
	IndexTranslogSeqnoPersistedTimeInMillis   int64 `json:"index_translog_seqno_persisted_time_in_millis"`
	DeleteTranslogSeqnoPersistedTotal         int64 `json:"delete_translog_seqno_persisted_total"`
	DeleteTranslogSeqnoPersistedTimeInMillis  int64 `json:"delete_translog_seqno_persisted_time_in_millis"`
	IndexUnderLockTotal                       int64 `json:"index_under_lock_total"`
	IndexUnderLockTimeInMillis                int64 `json:"index_under_lock_time_in_millis"`
}
